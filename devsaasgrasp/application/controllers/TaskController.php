...
class TaskController extends Zend_Controller_Action
{
    ...
    public function saveAction()
    {
    	...
    	$sql = "INSERT INTO task (name, description, billable, rate, created_by, created_date, status) "
    	     . "VALUES (?,?,?,?,?, NOW(), 'A')";
    	$param = array($params['task_name'], $params['task_desc'], 
    			isset($params['billable']) ? 1 : 0
    			, $params['rate'], $_SESSION['admin_id']);
    	...
    	$this->_redirect('/task/detail/id/' . $id);
