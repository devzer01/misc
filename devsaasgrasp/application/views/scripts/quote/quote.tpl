...
<h2 class="button-panel-title">
	...
	<div class="button-panel">	
					<a href="/quote/detail/quote/{$quote.proposal_id}" class="button"><span>Edit</span></a>
				
					<span class="spacer"></span>
					<a href="/quote/pdf/id/{$quote.proposal_id}" class="button"><span>PDF</span></a>

					<span class="spacer"></span>
					<a href="/quote/print/id/{$quote.proposal_id}" class="button"><span>Print</span></a>
...
<td>{$quote.quote_date|date_format}</td>
</tr>
<tr>
<th>Estimate Total:</th>
<td>{$settings[$smarty.const.SYSTEM_CURRENCY].value}{$total|number_format:2}</td>
</tr>
</table>
</div>
...
<tr><td>{$terms.comment_text}
<table cellpadding="2" cellspacing="0">
<tr>
<th><strong>Subtotal:</strong></th>
<td><strong>{$settings[$smarty.const.SYSTEM_CURRENCY].value}{$total|number_format:2}</strong></td>
</tr>
<tr>
