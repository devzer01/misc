	...
	<tr><td>
		<table width='800px'>
			<tr>
				...
				<td style='width: 250px'><div class="inv_title">INVOICE</div></td>
...
<tr>
<th>Invoice #:</th>
<td class='bd'>{$armc.armc_id}</td>
</tr>
<tr>
<th>Date:</th>

<td class='bd'>{$armc.invoice_date|date_format}</td>
</tr>
<tr>
<th>Invoice Total:</th>
<td class='bd'>${$total|number_format:2}</td>
</tr>
</table>
				</td>
			</tr>
			...
			<td style='width: 200px;'>&nbsp;</td>
				<td>
					<table width='300px;' cellpadding="2" cellspacing="0">
						...
						<td class='bd'><strong>${$total|number_format:2}</strong></td>
						</tr>
						<tr>
