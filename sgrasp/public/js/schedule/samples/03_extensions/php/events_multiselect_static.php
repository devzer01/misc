<?php
	require_once ('../../../../js/schedule/scheduler_connector.phpor.php');
	require_once../../../../js/schedule/crosslink_connector.phpctor.php');
	require../../../../js/schedule/config.phpsamples/common/config.php');
