                           ...
                           <table width="100%">
         	                 <tr>
         		                ...
         		                <td align="right">
         		                   ...
         		                   {if $display.column_filter eq 1}[<A href='#' onclick="window.open('/app/Common/DisplayModuleColumn/module/{$frontpage_manager->GetModule()}','app_popup','width=400,height=450,scrollbars=yes,resizable=yes');">Column Filter</a>]{/if}
         		                   
         		                   {if $meta.display_all neq 1}
                                  {if $meta.start neq "0"}
                                  ...
                                  {if $meta.start < $meta.last_page_start and $meta.total_rows > $meta.page_rows}
                                  ...
                                  {/if}
                                  {else}
                                    [<a href="javascript:void(0);" onclick="document.table_header_scroll.display_all.value=0; document.table_header_scroll.submit();">Display Pages</a>]&nbsp;&nbsp;
                                  {/if}
                                  ...
                                  {/if}
                                  [<a href='#' onclick="document.table_header_scroll.export_excel.value=1; document.table_header_scroll.submit();">Excel</a>]
                                  ...
                                  {foreach from=$hidden_fields item="hidden_field"}
                                  <input type="hidden" name="{$hidden_field.name}" id="{$hidden_field.name}" value="{$hidden_field.value}">
                                  {/foreach}
                                  </form>
                                  <!--
                                  <script>
