...
{
	private $api_key = '2xqZxcT5fR_p_c62qUZF';
	private $test_api_key = '2xqZxcT5fR_p_c62qUZF';
	private $domain = 'savezapp-usd'; //your chargify domain, e.g. if you have [your-domain].chargify.com, then enter "your-domain" only.
	private $test_domain = 'savezapp-usd';
	
	private $active_api_key;
	private $active_domain;
	private $test_mode;
	
	private $username = '2xqZxcT5fR_p_c62qUZF';
	private $password = 'x';
